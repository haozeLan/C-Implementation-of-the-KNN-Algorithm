  此作业为C++与面向对象编程的大作业，其目的在于使学生动手编写面向对象思想的程序。此程序经历多次修改，从struct转为class，再到根据功能构造多个class，最后还添加了异常处理的部分（GPT门），取得了不错的成绩
虽然算不上“大”，功能也很简陋，但确确实实是让从大学才开始学CS的本人完成了自己的作品，特此鸣谢朱晓旭老师(*^▽^*)
